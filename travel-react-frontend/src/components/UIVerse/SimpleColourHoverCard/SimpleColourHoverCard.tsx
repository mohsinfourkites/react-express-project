      ...
      <div className="card">
        ...
        <div className="text">
          ...
          <div className="icon-box">
            <svg version="1.1" className="svg" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512.001 512.001" xmlSpace="preserve">
              <g>
      	...
      	C442.01,116.493,444.197,117.371,446.539,117.17z" />
            ...
            <p className="span">Business Trip
            </p></div>
        </div>
      </div>
    </StyledWrapper>
...
export default SimpleColourHoverCard;
